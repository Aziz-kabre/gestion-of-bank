...
<head>
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Saisie de Retrait</h1>
          
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">Transaction</li>
          <li class="breadcrumb-item"><a href="#">Retrait</a></li>
        </ul>
      </div>
      <div class="row">
          ...
          <div class="tile">
            ...
            <div class="tile-body">
              <form class="row" action="" method="POST">
                ...
                <div class="form-group col-md-12">
                  <label class="control-label"><b>Montant Retrait</b></label>
                  <input class="form-control" type="text" name="sai_montant">
                </div>

                <div class="form-group col-md-12">
                  <label class="control-label"><b>Code Secret</b></label>
                  <input class="form-control" type="text" name="sai_code_secret">
                </div>
